// THIS CODE NEEDS TO GO (unless I can get it under MIT license).
// I got it from http://www.codeproject.com/Articles/19274/A-printf-implementation-in-C as I could not find a
// C# implementation of sprintf (I know, right?). It's pretty good as a C# sprintf for the purpose of logging.
// It's licensed under The Code Project Open License (CPOL) - http://www.codeproject.com/info/cpol10.aspx - which 
// while very lenient could prevent some people from using this code which is exactly what I don't want.
...
namespace AT.MIN
{
    ...
    public static class Tools
    {
        ...
        /// </summary>
        /// <param name="Value">The value.</param>
        /// <param name="Round">Round it?</param>
